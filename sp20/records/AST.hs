...
type R5Program = ([R5RecordDef], [R5Definition], R5Expr)
type TypedR5Program = ([R5RecordDef], [TypedR5Definition], TypedR5Expr)
...
data R5RecordDef = RecDef String [(String, Type)]
  deriving (Eq, Ord, Show)
