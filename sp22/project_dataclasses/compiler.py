...
def remove_classes(prog: Module) -> Module:
    """
    Compiles classes and field references into Tuple operations.
    :param prog: The Ltup program with dataclasses
    :return: The Ltup program without dataclasses
    """
...
def print_x86(inputs: TupleType[x86.Program, int]) -> str:
    """
